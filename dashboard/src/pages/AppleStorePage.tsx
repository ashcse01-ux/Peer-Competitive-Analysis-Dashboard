...
export default function AppleStorePage() {
  ...
  if (isLoading) return <div className="glass-panel p-6 text-sm font-semibold text-slate-500">Loading Apple App Store metrics…</div>
      ...
      <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          <SectionHeader
            ...
            subtitle="Same 15 review topics as Google Play — compare iOS passenger voice."
